...
#ifndef COMPUTATION_CLIENT_CACHE_H_
#define COMPUTATION_CLIENT_CACHE_H_
...
class Cache {
 ...
 private:
  ...
  using ElementMap = std::unordered_map<const K*, typename ElementList::iterator, Hasher, Equaler>;
...
#endif  // COMPUTATION_CLIENT_CACHE_H_
