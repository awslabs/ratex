...
Put::Put(const Value& input, const Value& index, const Value& source, bool accumulate)
...
NodePtr Put::Clone(OpList operands) const {
  return MakeNode<Put>(operands.at(0), operands.at(1), operands.at(2), accumulate_);
}
