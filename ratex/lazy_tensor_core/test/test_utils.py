...
import ratex.lazy_tensor_core.debug.metrics as met
import ratex.lazy_tensor_core.debug.metrics_compare_utils as mcu
...
def mp_test(func):
    ...
    Example::
      ...
      import ratex.lazy_tensor_core.test.test_utils as xtu
      import unittest
