...
# Testing on 2 GPU's, more GPU's causes an error
LTC_IO_THREAD_POOL_SIZE=1 mpirun -np 2 --allow-run-as-root python3 tests/python/model/test_ratex_fully_sharded_data_parallel.py