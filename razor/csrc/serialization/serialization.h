...
class ShapeNode : public Object {
 public:
  ...
  static constexpr const char* _type_key = "razor.Shape";
  static constexpr const bool _type_has_method_sequal_reduce = true;
  static constexpr const bool _type_has_method_shash_reduce = true;
...
class ProgramShapeNode : public Object {
 public:
  ...
  static constexpr const char* _type_key = "razor.ProgramShape";
  static constexpr const bool _type_has_method_sequal_reduce = true;
  static constexpr const bool _type_has_method_shash_reduce = true;
...
class ComputationNode : public Object {
 public:
  ...
  static constexpr const char* _type_key = "razor.Computation";
  static constexpr const bool _type_has_method_sequal_reduce = true;
  static constexpr const bool _type_has_method_shash_reduce = true;
...
class BaseComputationNode : public ComputationNode {
 public:
  ...
  static constexpr const char* _type_key = "razor.BaseComputation";
  static constexpr const bool _type_has_method_sequal_reduce = true;
  static constexpr const bool _type_has_method_shash_reduce = true;
