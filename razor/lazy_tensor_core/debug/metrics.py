...
def counter_names():
    ...
    return _RAZORC._ltc_counter_names()
...
def counter_value(name):
    ...
    """
    return _RAZORC._ltc_counter_value(name)


def metric_names():
    """Retrieves all the currently active metric names."""
    return _RAZORC._ltc_metric_names()
...
def metric_data(name):
    ...
    """
    return _RAZORC._ltc_metric_data(name)


def metrics_report():
    """Retrieves a string containing the full metrics and counters report."""
    return _RAZORC._ltc_metrics_report()
