...
def create_report(frames):
    ...
    report = []
    report.append("=" * 80)
    report.append("Unlowered Op usage summary (more of these ops, lower performance)")
    report.append("Note: _local_scalar_dense typically indicates CPU context access")
    report.append("-" * 80)
    for key in mrkeys:
