...
class Helpers {
 public:
    ...
    switch (type) {
      ...
      case lazy_tensors::PrimitiveType::BF16:
        return lazy_tensors::LiteralUtil::CreateR0<lazy_tensors::bfloat16>(
            static_cast<lazy_tensors::bfloat16>(static_cast<float>(scalar_value)));
      ...
      case lazy_tensors::PrimitiveType::S64:
        return lazy_tensors::LiteralUtil::CreateR0<lazy_tensors::int64>(scalar_value);
      case lazy_tensors::PrimitiveType::U64:
        return lazy_tensors::LiteralUtil::CreateR0<lazy_tensors::uint64>(scalar_value);
      case lazy_tensors::PrimitiveType::S32:
        return lazy_tensors::LiteralUtil::CreateR0<lazy_tensors::int32>(scalar_value);
      case lazy_tensors::PrimitiveType::U32:
        return lazy_tensors::LiteralUtil::CreateR0<lazy_tensors::uint32>(scalar_value);
      case lazy_tensors::PrimitiveType::S16:
        return lazy_tensors::LiteralUtil::CreateR0<lazy_tensors::int16>(scalar_value);
      case lazy_tensors::PrimitiveType::U16:
        return lazy_tensors::LiteralUtil::CreateR0<lazy_tensors::uint16>(scalar_value);
      case lazy_tensors::PrimitiveType::S8:
        return lazy_tensors::LiteralUtil::CreateR0<lazy_tensors::int8>(scalar_value);
      case lazy_tensors::PrimitiveType::U8:
        return lazy_tensors::LiteralUtil::CreateR0<lazy_tensors::uint8>(scalar_value);
      ...
      case lazy_tensors::PrimitiveType::C64:
        return lazy_tensors::LiteralUtil::CreateR0<lazy_tensors::complex64>(scalar_value);
      case lazy_tensors::PrimitiveType::C128:
        return lazy_tensors::LiteralUtil::CreateR0<lazy_tensors::complex128>(scalar_value);
      default:
  ...
  static std::vector<lazy_tensors::int64> GetAllDimensions(const lazy_tensors::Shape& shape) {
  ...
  static c10::optional<lazy_tensors::int64> I64Optional(c10::optional<int64_t> opt) {
  ...
  static lazy_tensors::int64 GetCanonicalDimensionIndex(lazy_tensors::int64 dim,
  ...
  static std::vector<lazy_tensors::int64> GetCanonicalDimensionIndices(
      lazy_tensors::Span<const lazy_tensors::int64> dimensions, lazy_tensors::int64 rank);
  ...
  static lazy_tensors::int64 GetCanonicalPosition(
      lazy_tensors::Span<const lazy_tensors::int64> dimensions, lazy_tensors::int64 dim,
      lazy_tensors::int64 pos);

  // Retrieves the dynamic dimension of an input shape, or returns -1 if none.
  static lazy_tensors::int64 GetDynamicDimension(const lazy_tensors::Shape& shape);
  ...
  static std::vector<typename Container::value_type> Permute(
      lazy_tensors::Span<const lazy_tensors::int64> permutation, const Container& input) {
  ...
  static std::vector<lazy_tensors::int64> MakeTransposePermutation(lazy_tensors::int64 dim0,
