...
DiscreteUniform::DiscreteUniform(const Value& from, const Value& to, const Value& seed,
...
NodePtr DiscreteUniform::Clone(OpList operands) const {
  return MakeNode<DiscreteUniform>(operands.at(0), operands.at(1), operands.at(2), shape());
}
