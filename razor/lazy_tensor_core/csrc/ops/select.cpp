...
Select::Select(const Value& input, lazy_tensors::int64 dim, lazy_tensors::int64 start,
...
lazy_tensors::int64 Select::GetStride(lazy_tensors::int64 start, lazy_tensors::int64 end,
