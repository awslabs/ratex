...
Sum::Sum(const Value& input, std::vector<int64_t> dimensions, bool keep_reduced_dimensions,
...
NodePtr Sum::Clone(OpList operands) const {
  return MakeNode<Sum>(operands.at(0), dimensions_, keep_reduced_dimensions_, dtype_);
}
