...
NllLoss2dBackward::NllLoss2dBackward(const Value& grad_output, const Value& logits,
...
NodePtr NllLoss2dBackward::Clone(OpList operands) const {
  ...
  return MakeNode<NllLoss2dBackward>(operands.at(0), operands.at(1), operands.at(2), weight,
