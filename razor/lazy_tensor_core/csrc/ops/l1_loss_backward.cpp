...
L1LossBackward::L1LossBackward(const Value& grad_output, const Value& input, const Value& target,
...
NodePtr L1LossBackward::Clone(OpList operands) const {
  return MakeNode<L1LossBackward>(operands.at(0), operands.at(1), operands.at(2), reduction_);
}
