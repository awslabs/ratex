...
NativeBatchNormBackward::NativeBatchNormBackward(const Value& grad_out, const Value& input,
...
NodePtr NativeBatchNormBackward::Clone(OpList operands) const {
  return MakeNode<NativeBatchNormBackward>(operands.at(0), operands.at(1), operands.at(2),
