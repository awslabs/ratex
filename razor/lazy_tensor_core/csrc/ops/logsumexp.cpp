...
Logsumexp::Logsumexp(const Value& input, std::vector<lazy_tensors::int64> dimensions,
...
NodePtr Logsumexp::Clone(OpList operands) const {
  return MakeNode<Logsumexp>(operands.at(0), dimensions_, keep_reduced_dimensions_);
}
