...
class ClientWorker(Worker):
    ...
    def __repr__(self):
        return ("{{{internal_ip}, {machine_type}, {zone}," " {hostname}}}").format(
    ...
    def __eq__(self, other):
        return (
            self._internal_ip == other._internal_ip
...
class ServiceWorker(Worker):
    def __init__(self, internal_ip, port, machine_type, zone, runtime_version, tpu=None):
    ...
    def __repr__(self):
        return (
            "{{{internal_ip}, {port}, {machine_type}, {zone}," " {runtime_version}, {tpu}}}"
        ).format(
            internal_ip=self._internal_ip,
            port=self._port,
            machine_type=self._machine_type,
    ...
    def __eq__(self, other):
        return (
            ...
            and self._machine_type == other._machine_type
            and self._zone == other._zone
            and self._runtime_version == other._runtime_version
            and self._tpu == other._tpu
        )
