...
import razor.lazy_tensor_core.core.lazy_model as ltm
import razor.lazy_tensor_core.debug.metrics as met
import razor.lazy_tensor_core.debug.metrics_compare_utils as mcu
...
def mp_test(func):
    ...
    Example::
      ...
      import razor.lazy_tensor_core.test.test_utils as xtu
      import unittest
