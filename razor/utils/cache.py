...
PERSIST_DIR = os.environ.get("RAZOR_CACHE_DIR", Path.home() / ".razor_cache")
...
@tvm._ffi.register_func("razor.utils.cache.query")
def query(key):
...
@tvm._ffi.register_func("razor.utils.cache.create_entry")
