...
class LazyTensor {
 ...
 public:
  ...
  static LazyTensor get_dimensions_size(const LazyTensor& input,
  ...
  static LazyTensor adaptive_avg_pool3d(const LazyTensor& input,
  ...
  static LazyTensor _adaptive_avg_pool2d(const LazyTensor& input,
                                         std::vector<lazy_tensors::int64> output_size);
  ...
  static LazyTensor add(const LazyTensor& input, const LazyTensor& other, const at::Scalar& alpha,
                        c10::optional<at::ScalarType> logical_element_type = c10::nullopt);
  static void add_(LazyTensor& input, const LazyTensor& other, const at::Scalar& alpha);
  static LazyTensor add(const LazyTensor& input, const at::Scalar& other, const at::Scalar& alpha,
                        c10::optional<at::ScalarType> logical_element_type = c10::nullopt);
  static void add_(LazyTensor& input, const at::Scalar& other, const at::Scalar& alpha);

  static LazyTensor addcdiv(const LazyTensor& input, const at::Scalar& value,
                            const LazyTensor& tensor1, const LazyTensor& tensor2);
  static void addcdiv_(LazyTensor& input, const at::Scalar& value, const LazyTensor& tensor1,
                       const LazyTensor& tensor2);

  static LazyTensor addcmul(const LazyTensor& input, const at::Scalar& value,
                            const LazyTensor& tensor1, const LazyTensor& tensor2);
  static void addcmul_(LazyTensor& input, const at::Scalar& value, const LazyTensor& tensor1,
                       const LazyTensor& tensor2);

  static LazyTensor addmm(const LazyTensor& input, const LazyTensor& weight,
                          const LazyTensor& bias);

  static LazyTensor all(const LazyTensor& input, std::vector<lazy_tensors::int64> dimensions,
                        bool keep_reduced_dimensions);

  static LazyTensor any(const LazyTensor& input, std::vector<lazy_tensors::int64> dimensions,
                        bool keep_reduced_dimensions);
  ...
  static LazyTensor argmax(const LazyTensor& input, lazy_tensors::int64 dim, bool keepdim);
  static LazyTensor argmax(const LazyTensor& input);

  static LazyTensor argmin(const LazyTensor& input, lazy_tensors::int64 dim, bool keepdim);
  ...
  static LazyTensor as_strided(const LazyTensor& input, std::vector<lazy_tensors::int64> size,
                               std::vector<lazy_tensors::int64> stride,
                               c10::optional<lazy_tensors::int64> storage_offset);

  // In-place version of the method above.
  static void as_strided_(LazyTensor& input, std::vector<lazy_tensors::int64> size,
                          std::vector<lazy_tensors::int64> stride,
                          c10::optional<lazy_tensors::int64> storage_offset);
  ...
  static LazyTensor avg_pool_nd(const LazyTensor& input, lazy_tensors::int64 spatial_dim_count,
  ...
  static void baddbmm_(LazyTensor& input, const LazyTensor& batch1, const LazyTensor& batch2,
  ...
  static LazyTensor cat(lazy_tensors::Span<const LazyTensor> tensors, lazy_tensors::int64 dim);
  ...
  // high paddings.
  static LazyTensor constant_pad_nd(const LazyTensor& input,
  ...
  static LazyTensor diagonal(const LazyTensor& input, lazy_tensors::int64 offset,
  ...
  static void div_(LazyTensor& input, const LazyTensor& other,
                   const c10::optional<std::string>& rounding_mode = c10::nullopt);
  ...
  static void elu_(LazyTensor& input, const at::Scalar& alpha, const at::Scalar& scale,
                   const at::Scalar& input_scale);
  ...
  static LazyTensor expand(const LazyTensor& input, std::vector<lazy_tensors::int64> size);
  ...
  static LazyTensor eye(lazy_tensors::int64 lines, lazy_tensors::int64 cols, const Device& device,
                        at::ScalarType element_type);

  static void eye_out(LazyTensor& out, lazy_tensors::int64 lines, lazy_tensors::int64 cols);
  ...
  static void index_add_(LazyTensor& input, lazy_tensors::int64 dim, const LazyTensor& index,
                         const LazyTensor& source);

  static LazyTensor index_copy(const LazyTensor& input, lazy_tensors::int64 dim,
                               const LazyTensor& index, const LazyTensor& source);

  static void index_copy_(LazyTensor& input, lazy_tensors::int64 dim, const LazyTensor& index,
                          const LazyTensor& source);
  ...
  static void index_fill_(LazyTensor& input, lazy_tensors::int64 dim, const LazyTensor& index,
  ...
  static LazyTensor index_select(const LazyTensor& input, lazy_tensors::int64 dim,
                                 const LazyTensor& index);
  ...
  static std::tuple<LazyTensor, LazyTensor> kthvalue(const LazyTensor& input, lazy_tensors::int64 k,
  ...
  static LazyTensor log_softmax(const LazyTensor& input, lazy_tensors::int64 dim,
                                c10::optional<at::ScalarType> dtype);
  ...
  static LazyTensor logsumexp(const LazyTensor& input, std::vector<lazy_tensors::int64> dimensions,
                              bool keep_reduced_dimensions);
  ...
  static std::tuple<LazyTensor, LazyTensor> max(const LazyTensor& input, lazy_tensors::int64 dim,
                                                bool keepdim);

  static void max_out(LazyTensor& max, LazyTensor& max_values, const LazyTensor& input,
                      lazy_tensors::int64 dim, bool keepdim);
  ...
  static LazyTensor mean(const LazyTensor& input, std::vector<lazy_tensors::int64> dimensions,
  ...
  static std::tuple<LazyTensor, LazyTensor> min(const LazyTensor& input, lazy_tensors::int64 dim,
                                                bool keepdim);
  ...
  static LazyTensor prod(const LazyTensor& input, std::vector<lazy_tensors::int64> dimensions,
                         bool keep_reduced_dimensions, c10::optional<at::ScalarType> dtype);
  ...
  // repeats.
  static LazyTensor repeat(const LazyTensor& input, std::vector<lazy_tensors::int64> repeats);
  ...
  static void scatter_(LazyTensor& input, lazy_tensors::int64 dim, const LazyTensor& index,
                       const LazyTensor& src);
  static void scatter_(LazyTensor& input, lazy_tensors::int64 dim, const LazyTensor& index,
                       const at::Scalar& value);

  static void scatter_add_(LazyTensor& input, lazy_tensors::int64 dim, const LazyTensor& index,
                           const LazyTensor& src);
  ...
  static std::vector<LazyTensor> split(const LazyTensor& input, lazy_tensors::int64 split_size,
                                       lazy_tensors::int64 dim);
  ...
  static LazyTensor stack(lazy_tensors::Span<const LazyTensor> tensors, lazy_tensors::int64 dim);

  static LazyTensor std(const LazyTensor& input, std::vector<lazy_tensors::int64> dimensions,
  ...
  static LazyTensor sub(const LazyTensor& input, const LazyTensor& other, const at::Scalar& alpha,
                        c10::optional<at::ScalarType> logical_element_type = c10::nullopt);
  static void sub_(LazyTensor& input, const LazyTensor& other, const at::Scalar& alpha);
  static LazyTensor sub(const LazyTensor& input, const at::Scalar& other, const at::Scalar& alpha,
                        c10::optional<at::ScalarType> logical_element_type = c10::nullopt);
  static void sub_(LazyTensor& input, const at::Scalar& other, const at::Scalar& alpha);

  static LazyTensor sum(const LazyTensor& input, std::vector<lazy_tensors::int64> dimensions,
                        bool keep_reduced_dimensions, c10::optional<at::ScalarType> dtype);
  ...
  static std::tuple<LazyTensor, LazyTensor> topk(const LazyTensor& input, lazy_tensors::int64 k,
  ...
  // In-place version of the method above.
  static void transpose_(LazyTensor& input, lazy_tensors::int64 dim0, lazy_tensors::int64 dim1);
  ...
  // removed.
  static std::vector<LazyTensor> unbind(const LazyTensor& input, lazy_tensors::int64 dim);
  ...
  static LazyTensor upsample_bilinear2d(const LazyTensor& input,
                                        std::vector<lazy_tensors::int64> output_size,
                                        bool align_corners);
  ...
  static LazyTensor upsample_nearest2d(const LazyTensor& input,
                                       std::vector<lazy_tensors::int64> output_size);
  ...
  static LazyTensor var(const LazyTensor& input, std::vector<lazy_tensors::int64> dimensions,
                        lazy_tensors::int64 correction, bool keep_reduced_dimensions);

  // Like reshape, but it returns a view into the original tensor.
  static LazyTensor view(const LazyTensor& input,
