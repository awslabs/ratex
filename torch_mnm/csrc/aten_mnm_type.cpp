...
bool IsSupportedAdaptiveAvgPool(absl::Span<const lazy_tensors::int64> input_size,
                                absl::Span<const lazy_tensors::int64> output_size,
                                int pool_dim) {
...
ExecutionKind InPlaceMustUseNNC(const at::Tensor& self) {
  const LazyTensor self_tensor = bridge::mnm_backend::GetLtcTensor(self);
...
at::Tensor& AtenMNMType::__ilshift__(at::Tensor& self,
                                     const at::Scalar& other) {
  LTC_FN_COUNTER("mnm::");
  LazyTensor self_tensor = bridge::mnm_backend::GetLtcTensor(self);
...
at::Tensor& AtenMNMType::__irshift__(at::Tensor& self,
                                     const at::Scalar& other) {
  LTC_FN_COUNTER("mnm::");
  CheckBinaryOpTypePromotion(self, self, other);
  LazyTensor self_tensor = bridge::mnm_backend::GetLtcTensor(self);
...
at::Tensor AtenMNMType::__lshift__(const at::Tensor& self,
                                   const at::Scalar& other) {
  LTC_FN_COUNTER("mnm::");
...
at::Tensor AtenMNMType::__rshift__(const at::Tensor& self,
                                   const at::Scalar& other) {
  LTC_FN_COUNTER("mnm::");
  return DoBinaryOp(self, other,
                    [&](const LazyTensor& xself, const at::Scalar& other,
...
at::Tensor AtenMNMType::_adaptive_avg_pool3d(const at::Tensor& self,
  ...
  return bridge::AtenFromLtcTensor(LazyTensor::adaptive_avg_pool3d(
      bridge::mnm_backend::GetLtcTensor(self), output_size_list));
}

at::Tensor AtenMNMType::_adaptive_avg_pool3d_backward(
    const at::Tensor& grad_output, const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  int64_t rank = grad_output.dim();
  std::vector<lazy_tensors::int64> output_size{grad_output.size(rank - 3),
...
at::Tensor AtenMNMType::_adaptive_avg_pool2d(const at::Tensor& self,
                                             at::IntArrayRef output_size) {
  LTC_FN_COUNTER("mnm::");
  auto output_size_list = Helpers::I64List(output_size);
  if (!IsSupportedAdaptiveAvgPool(Helpers::I64List(self.sizes()),
...
at::Tensor AtenMNMType::_adaptive_avg_pool2d_backward(
    const at::Tensor& grad_output, const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  int64_t rank = grad_output.dim();
...
void AtenMNMType::_amp_foreach_non_finite_check_and_unscale_(
...
at::Tensor& AtenMNMType::_amp_update_scale_(at::Tensor& current_scale,
  ...
  LazyTensor::_amp_update_scale_(growth_tracker_tensor, current_scale_tensor,
                                 bridge::mnm_backend::GetLtcTensor(found_inf),
                                 scale_growth_factor, scale_backoff_factor,
                                 growth_interval);
  return current_scale;
}

at::Tensor AtenMNMType::_copy_from(const at::Tensor& self,
  ...
  if (!self_tensor) {
    static bool sync_update =
        lazy_tensors::sys_util::GetEnvBool("MNM_TENSOR_UPDATE_SYNC", true);
...
at::Tensor& AtenMNMType::_index_put_impl_(
...
ir::Value MaybeCastIrValue(
    const LazyTensor& self, ir::Value ir_value, const Device& device,
...
ir::NodePtr LogSoftmaxBackwardUseInOp(const ir::Value& grad_output, const ir::Value& output,
  ...
  return ir::MakeNode<ir::ops::LogSoftmaxBackwardUseIn>(
      grad_output, output,
      Helpers::GetCanonicalDimensionIndex(dim, grad_output.shape().rank()), self);
}
...
LazyTensor log_softmax_backward(const LazyTensor& grad_output,
  ...
  return CreateFrom(grad_output, LogSoftmaxBackwardUseInOp(
      grad_output.GetIrValue(), output.GetIrValue(), dim, self.GetIrValue()));
}

at::Tensor AtenMNMType::_log_softmax_backward_data(
    const at::Tensor& grad_output, const at::Tensor& output, int64_t dim,
    const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(log_softmax_backward(
    bridge::mnm_backend::GetLtcTensor(grad_output), bridge::mnm_backend::GetLtcTensor(output), dim, bridge::mnm_backend::GetLtcTensor(self)));
  // return bridge::AtenFromLtcTensor(LazyTensor::log_softmax_backward(
  //     bridge::mnm_backend::GetLtcTensor(grad_output), bridge::mnm_backend::GetLtcTensor(output), dim));
}

std::tuple<at::Tensor, at::Tensor> AtenMNMType::_pack_padded_sequence(
...
at::Tensor AtenMNMType::_s_where(const at::Tensor& condition,
                                 const at::Tensor& self,
                                 const at::Tensor& other) {
  if (ForceNNC()) {
    LTC_FN_COUNTER("mnm::");
    return bridge::AtenFromLtcTensor(LazyTensor::where(
        bridge::mnm_backend::GetLtcTensor(condition), bridge::mnm_backend::GetLtcTensor(self),
        bridge::mnm_backend::GetLtcTensor(other)));
  }
  return AtenMNMTypeDefault::_s_where(condition, self, other);
}

at::Tensor AtenMNMType::_softmax(const at::Tensor& self, int64_t dim,
                                 bool /* half_to_float */) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
...
at::Tensor AtenMNMType::_trilinear(const at::Tensor& i1, const at::Tensor& i2,
                                   const at::Tensor& i3,
                                   at::IntArrayRef expand1,
                                   at::IntArrayRef expand2,
                                   at::IntArrayRef expand3,
                                   at::IntArrayRef sumdim, int64_t unroll_dim) {
  return AtenMNMTypeDefault::_trilinear(i1, i2, i3, expand1, expand2, expand3,
                                        sumdim, unroll_dim);
}

at::Tensor AtenMNMType::_unsafe_view(const at::Tensor& self,
                                     at::IntArrayRef size) {
  LazyTensor self_tensor = bridge::mnm_backend::GetLtcTensor(self);
  ...
  auto result = AtenMNMTypeDefault::_unsafe_view(self, size);
...
at::Tensor AtenMNMType::abs(const at::Tensor& self) {
  if (UseNNC(self)) {
    LTC_FN_COUNTER("mnm::");
    return bridge::AtenFromLtcTensor(
        LazyTensor::abs(bridge::mnm_backend::GetLtcTensor(self)));
  }
  return AtenMNMTypeDefault::abs(self);
}
...
at::Tensor& AtenMNMType::abs_(at::Tensor& self) {
  ...
  return AtenMNMTypeDefault::abs_(self);
}

at::Tensor AtenMNMType::acos(const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::acos(bridge::mnm_backend::GetLtcTensor(self)));
}
...
at::Tensor& AtenMNMType::acos_(at::Tensor& self) {
  ...
  return AtenMNMTypeDefault::acos_(self);
}
...
at::Tensor AtenMNMType::add(const at::Tensor& self, const at::Tensor& other,
  ...
  return AtenMNMTypeDefault::add(self, other, alpha);
}
...
at::Tensor& AtenMNMType::add_(at::Tensor& self, const at::Tensor& other,
                              const at::Scalar& alpha) {
...
at::Tensor& AtenMNMType::add_(at::Tensor& self, const at::Scalar& other,
                              const at::Scalar& alpha) {
  if (InPlaceUseNNC(self) == ExecutionKind::NNC) {
    LTC_FN_COUNTER("mnm::");
    CheckBinaryOpTypePromotion(self, self, other);
...
at::Tensor AtenMNMType::addcdiv(const at::Tensor& self,
...
at::Tensor AtenMNMType::addcmul(const at::Tensor& self,
                                const at::Tensor& tensor1,
                                const at::Tensor& tensor2,
                                const at::Scalar& value) {
  LTC_FN_COUNTER("mnm::");
...
at::Tensor& AtenMNMType::arange_out(const at::Scalar& start,
                                    const at::Scalar& end,
...
at::Tensor AtenMNMType::as_strided(const at::Tensor& self, at::IntArrayRef size,
  ...
  if (!UseNNCViews(self_tensor) &&
    ...
    auto result =
        AtenMNMTypeDefault::as_strided(self, size, stride, storage_offset);
    return result;
  }
  LTC_FN_COUNTER("mnm::");
...
const at::Tensor& AtenMNMType::as_strided_(
...
at::Tensor AtenMNMType::asin(const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::asin(bridge::mnm_backend::GetLtcTensor(self)));
}
...
at::Tensor AtenMNMType::atan(const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::atan(bridge::mnm_backend::GetLtcTensor(self)));
}
...
at::Tensor AtenMNMType::avg_pool2d(const at::Tensor& self,
  ...
  if ((ceil_mode && count_include_pad) || divisor_override) {
    return AtenMNMTypeDefault::avg_pool2d(self, kernel_size, stride, padding,
                                          ceil_mode, count_include_pad,
                                          divisor_override);
  }
  return bridge::AtenFromLtcTensor(LazyTensor::avg_pool_nd(
      bridge::mnm_backend::GetLtcTensor(self), /*spatial_dim_count=*/2,
      Helpers::I64List(kernel_size), Helpers::I64List(stride),
      Helpers::I64List(padding), ceil_mode, count_include_pad));
}

at::Tensor AtenMNMType::avg_pool2d_backward(
    const at::Tensor& grad_output, const at::Tensor& self,
  ...
  LTC_FN_COUNTER("mnm::");
  if ((ceil_mode && count_include_pad) || divisor_override) {
    return AtenMNMTypeDefault::avg_pool2d_backward(
...
at::Tensor AtenMNMType::avg_pool3d(const at::Tensor& self,
                                   at::IntArrayRef kernel_size,
                                   at::IntArrayRef stride,
                                   at::IntArrayRef padding, bool ceil_mode,
                                   bool count_include_pad,
  ...
  LTC_FN_COUNTER("mnm::");
  if ((ceil_mode && count_include_pad) || divisor_override) {
    return AtenMNMTypeDefault::avg_pool3d(self, kernel_size, stride, padding,
                                          ceil_mode, count_include_pad,
                                          divisor_override);
  }
  return bridge::AtenFromLtcTensor(LazyTensor::avg_pool_nd(
      bridge::mnm_backend::GetLtcTensor(self), /*spatial_dim_count=*/3,
      Helpers::I64List(kernel_size), Helpers::I64List(stride),
      Helpers::I64List(padding), ceil_mode, count_include_pad));
}

at::Tensor AtenMNMType::avg_pool3d_backward(
    const at::Tensor& grad_output, const at::Tensor& self,
    at::IntArrayRef kernel_size, at::IntArrayRef stride,
    at::IntArrayRef padding, bool ceil_mode, bool count_include_pad,
    c10::optional<int64_t> divisor_override) {
  LTC_FN_COUNTER("mnm::");
  if ((ceil_mode && count_include_pad) || divisor_override) {
    return AtenMNMTypeDefault::avg_pool3d_backward(
        grad_output, self, kernel_size, stride, padding, ceil_mode,
        count_include_pad, divisor_override);
  }
  return bridge::AtenFromLtcTensor(LazyTensor::avg_pool_nd_backward(
...
at::Tensor AtenMNMType::baddbmm(const at::Tensor& self,
...
at::Tensor AtenMNMType::bernoulli(const at::Tensor& self,
...
at::Tensor AtenMNMType::binary_cross_entropy(
...
at::Tensor AtenMNMType::binary_cross_entropy_backward(
    const at::Tensor& grad_output, const at::Tensor& self,
...
at::Tensor& AtenMNMType::bitwise_and_out(const at::Tensor& self,
                                         const at::Scalar& other,
                                         at::Tensor& out) {
  if (UseNNC(out)) {
    LTC_FN_COUNTER("mnm::");
  ...
  return AtenMNMTypeDefault::bitwise_and_out(self, other, out);
}
...
at::Tensor& AtenMNMType::bitwise_not_out(const at::Tensor& self,
                                         at::Tensor& out) {
  LTC_FN_COUNTER("mnm::");
  LazyTensor out_tensor = bridge::mnm_backend::GetLtcTensor(out);
  LazyTensor self_tensor = bridge::mnm_backend::GetLtcTensor(self);
...
at::Tensor& AtenMNMType::bitwise_or_out(const at::Tensor& self,
                                        const at::Scalar& other,
                                        at::Tensor& out) {
  LTC_FN_COUNTER("mnm::");
  CheckBinaryOpTypePromotion(out, self, other);
...
at::Tensor& AtenMNMType::bitwise_xor_out(const at::Tensor& self,
                                         const at::Scalar& other,
                                         at::Tensor& out) {
  LTC_FN_COUNTER("mnm::");
  CheckBinaryOpTypePromotion(out, self, other);
...
at::Tensor AtenMNMType::bmm(const at::Tensor& self, const at::Tensor& mat2) {
  ...
  return bridge::AtenFromLtcTensor(
      LazyTensor::bmm(bridge::mnm_backend::GetLtcTensor(self), bridge::mnm_backend::GetLtcTensor(mat2)));
}
...
at::Tensor AtenMNMType::ceil(const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::ceil(bridge::mnm_backend::GetLtcTensor(self)));
}
...
at::Tensor AtenMNMType::clamp(const at::Tensor& self,
...
at::Tensor& AtenMNMType::clamp_(at::Tensor& self,
                                const c10::optional<at::Scalar>& min,
                                const c10::optional<at::Scalar>& max) {
  if (InPlaceMustUseNNC(self) == ExecutionKind::NNC) {
    LTC_FN_COUNTER("mnm::");
...
at::Tensor AtenMNMType::clamp_max(const at::Tensor& self,
                                  const at::Scalar& max) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
...
at::Tensor& AtenMNMType::clamp_max_out(const at::Tensor& self,
                                       const at::Tensor& max, at::Tensor& out) {
  LTC_FN_COUNTER("mnm::");
  LazyTensor out_tensor = bridge::mnm_backend::GetLtcTensor(out);
  LazyTensor::clamp_out(out_tensor, bridge::mnm_backend::GetLtcTensor(self), c10::nullopt,
                        max);
  return out;
}

at::Tensor AtenMNMType::clamp_min(const at::Tensor& self,
                                  const at::Scalar& min) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
...
at::Tensor& AtenMNMType::clamp_min_out(const at::Tensor& self,
                                       const at::Tensor& min, at::Tensor& out) {
  LTC_FN_COUNTER("mnm::");
  LazyTensor out_tensor = bridge::mnm_backend::GetLtcTensor(out);
  LazyTensor::clamp_out(out_tensor, bridge::mnm_backend::GetLtcTensor(self), min,
                        c10::nullopt);
  return out;
}
...
at::Tensor AtenMNMType::clone(const at::Tensor& self,
  ...
  if (self_tensor.CurrentTensorData()) {
    return AtenMNMTypeDefault::clone(self, memory_format);
  }
...
at::Tensor AtenMNMType::constant_pad_nd(const at::Tensor& self,
                                        at::IntArrayRef pad,
                                        const at::Scalar& value) {
  LTC_FN_COUNTER("mnm::");
...
at::Tensor AtenMNMType::convolution_overrideable(
...
AtenMNMType::convolution_backward_overrideable(
...
at::Tensor AtenMNMType::cosh(const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::cosh(bridge::mnm_backend::GetLtcTensor(self)));
}
...
at::Tensor AtenMNMType::cross(const at::Tensor& self, const at::Tensor& other,
  ...
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::cross(bridge::mnm_backend::GetLtcTensor(self), bridge::mnm_backend::GetLtcTensor(other),
...
at::Tensor AtenMNMType::diagonal(const at::Tensor& self, int64_t offset,
...
at::Tensor AtenMNMType::div(const at::Tensor& self, const at::Tensor& other,
  ...
  return AtenMNMTypeDefault::div(self, other, rounding_mode);
}
...
at::Tensor AtenMNMType::div(const at::Tensor& self, const at::Scalar& other) {
  if (UseNNC(self)) {
    LTC_FN_COUNTER("mnm::");
    return bridge::AtenFromLtcTensor(
        LazyTensor::div(bridge::mnm_backend::GetLtcTensor(self), other));
  }
  return AtenMNMTypeDefault::div(self, other);
}
...
at::Tensor AtenMNMType::dot(const at::Tensor& self, const at::Tensor& tensor) {
  ...
  return bridge::AtenFromLtcTensor(LazyTensor::matmul(
      bridge::mnm_backend::GetLtcTensor(self), bridge::mnm_backend::GetLtcTensor(tensor)));
}
...
at::Tensor& AtenMNMType::elu_(at::Tensor& self, const at::Scalar& alpha,
                              const at::Scalar& scale,
                              const at::Scalar& input_scale) {
  if (InPlaceMustUseNNC(self) == ExecutionKind::NNC) {
    LTC_FN_COUNTER("mnm::");
...
at::Tensor AtenMNMType::elu_backward(const at::Tensor& grad_output,
                                     const at::Scalar& alpha,
                                     const at::Scalar& scale,
  ...
  return bridge::AtenFromLtcTensor(LazyTensor::elu_backward(
      bridge::mnm_backend::GetLtcTensor(grad_output), alpha, scale, input_scale,
      bridge::mnm_backend::GetLtcTensor(self_or_result)));
}

at::Tensor AtenMNMType::embedding(const at::Tensor& weight,
...
at::Tensor AtenMNMType::empty(at::IntArrayRef size,
                              c10::optional<at::ScalarType> dtype,
...
at::Tensor AtenMNMType::empty_strided(at::IntArrayRef size,
                                      at::IntArrayRef stride,
                                      c10::optional<at::ScalarType> dtype,
                                      c10::optional<at::Layout> layout,
                                      c10::optional<at::Device> device,
...
at::Tensor AtenMNMType::eq(const at::Tensor& self, const at::Scalar& other) {
  if (UseNNC(self)) {
    LTC_FN_COUNTER("mnm::");
    return bridge::AtenFromLtcTensor(
        LazyTensor::eq(bridge::mnm_backend::GetLtcTensor(self), other));
  }
  return AtenMNMTypeDefault::eq(self, other);
}
...
at::Tensor AtenMNMType::eq(const at::Tensor& self, const at::Tensor& other) {
  if (UseNNC(self)) {
    ...
    return bridge::AtenFromLtcTensor(LazyTensor::eq(
        bridge::mnm_backend::GetLtcTensor(self), bridge::mnm_backend::GetLtcTensor(other)));
  }
  return AtenMNMTypeDefault::eq(self, other);
}
...
at::Tensor AtenMNMType::erfc(const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::erfc(bridge::mnm_backend::GetLtcTensor(self)));
}
...
at::Tensor AtenMNMType::erfinv(const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::erfinv(bridge::mnm_backend::GetLtcTensor(self)));
}
...
at::Tensor AtenMNMType::expand(const at::Tensor& self, at::IntArrayRef size,
                               bool implicit) {
  if (ForceNNC()) {
    LTC_FN_COUNTER("mnm::");
    return bridge::AtenFromLtcTensor(
  ...
  return AtenMNMTypeDefault::expand(self, size, implicit);
}

at::Tensor AtenMNMType::expm1(const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::expm1(bridge::mnm_backend::GetLtcTensor(self)));
}
...
at::Tensor AtenMNMType::floor(const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::floor(bridge::mnm_backend::GetLtcTensor(self)));
}
...
at::Tensor AtenMNMType::frac(const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::frac(bridge::mnm_backend::GetLtcTensor(self)));
}
...
at::Tensor AtenMNMType::gather(const at::Tensor& self, int64_t dim,
...
at::Tensor AtenMNMType::ge(const at::Tensor& self, const at::Scalar& other) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::ge(bridge::mnm_backend::GetLtcTensor(self), other));
}

at::Tensor AtenMNMType::ge(const at::Tensor& self, const at::Tensor& other) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::ge(bridge::mnm_backend::GetLtcTensor(self), bridge::mnm_backend::GetLtcTensor(other)));
}
...
at::Tensor AtenMNMType::gelu(const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::gelu(bridge::mnm_backend::GetLtcTensor(self)));
}

at::Tensor AtenMNMType::gelu_backward(const at::Tensor& grad,
                                      const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
...
at::Tensor AtenMNMType::ger(const at::Tensor& self, const at::Tensor& vec2) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::ger(bridge::mnm_backend::GetLtcTensor(self), bridge::mnm_backend::GetLtcTensor(vec2)));
}
...
at::Tensor AtenMNMType::gt(const at::Tensor& self, const at::Scalar& other) {
  if (UseNNC(self)) {
    LTC_FN_COUNTER("mnm::");
    return bridge::AtenFromLtcTensor(
        LazyTensor::gt(bridge::mnm_backend::GetLtcTensor(self), other));
  }
  return AtenMNMTypeDefault::gt(self, other);
}
...
at::Tensor AtenMNMType::hardshrink(const at::Tensor& self,
...
at::Tensor AtenMNMType::hardshrink_backward(const at::Tensor& grad_out,
                                            const at::Tensor& self,
                                            const at::Scalar& lambda) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(LazyTensor::hardshrink_backward(
      bridge::mnm_backend::GetLtcTensor(grad_out), bridge::mnm_backend::GetLtcTensor(self), lambda));
}

at::Tensor AtenMNMType::hardtanh(const at::Tensor& self,
...
at::Tensor AtenMNMType::hardtanh_backward(const at::Tensor& grad_output,
                                          const at::Tensor& self,
                                          const at::Scalar& min_val,
                                          const at::Scalar& max_val) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(LazyTensor::hardtanh_backward(
      bridge::mnm_backend::GetLtcTensor(grad_output), bridge::mnm_backend::GetLtcTensor(self), min_val,
      max_val));
}

at::Tensor AtenMNMType::index(
    const at::Tensor& self,
...
at::Tensor& AtenMNMType::index_add_(at::Tensor& self, int64_t dim,
                                    const at::Tensor& index,
...
at::Tensor& AtenMNMType::index_copy_(at::Tensor& self, int64_t dim,
                                     const at::Tensor& index,
                                     const at::Tensor& source) {
  LTC_FN_COUNTER("mnm::");
  LazyTensor self_tensor = bridge::mnm_backend::GetLtcTensor(self);
...
at::Tensor& AtenMNMType::index_fill_(at::Tensor& self, int64_t dim,
                                     const at::Tensor& index,
                                     const at::Scalar& value) {
  LTC_FN_COUNTER("mnm::");
  LazyTensor self_tensor = bridge::mnm_backend::GetLtcTensor(self);
...
at::Tensor& AtenMNMType::index_put_(
    at::Tensor& self, const c10::List<c10::optional<at::Tensor>>& indices,
  ...
  LazyTensor::index_put_(
      self_tensor, bridge::mnm_backend::GetLtcTensor(canonical_index_info.base),
      bridge::mnm_backend::GetLtcTensors(canonical_index_info.indices),
      canonical_index_info.start_dim, bridge::mnm_backend::GetLtcTensor(values), accumulate,
      canonical_index_info.result_permutation);
  return self;
}

at::Tensor AtenMNMType::index_select(const at::Tensor& self, int64_t dim,
                                     const at::Tensor& index) {
  LTC_FN_COUNTER("mnm::");
...
at::Tensor AtenMNMType::inverse(const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::inverse(bridge::mnm_backend::GetLtcTensor(self)));
}

at::Tensor AtenMNMType::kl_div(const at::Tensor& self, const at::Tensor& target,
                               int64_t reduction, bool log_target) {
  LTC_FN_COUNTER("mnm::");
  return at::native::kl_div(self, target, reduction, log_target);
}

at::Tensor AtenMNMType::kl_div_backward(const at::Tensor& grad_output,
                                        const at::Tensor& self,
...
std::tuple<at::Tensor, at::Tensor> AtenMNMType::kthvalue(const at::Tensor& self,
                                                         int64_t k, int64_t dim,
                                                         bool keepdim) {
  LTC_FN_COUNTER("mnm::");
  auto results =
      LazyTensor::kthvalue(bridge::mnm_backend::GetLtcTensor(self), k, dim, keepdim);
  return std::make_tuple(bridge::AtenFromLtcTensor(std::get<0>(results)),
                         bridge::AtenFromLtcTensor(std::get<1>(results)));
}

at::Tensor AtenMNMType::l1_loss(const at::Tensor& self,
                                const at::Tensor& target, int64_t reduction) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(LazyTensor::l1_loss(
      bridge::mnm_backend::GetLtcTensor(self), bridge::mnm_backend::GetLtcTensor(target), reduction));
}

at::Tensor AtenMNMType::l1_loss_backward(const at::Tensor& grad_output,
                                         const at::Tensor& self,
                                         const at::Tensor& target,
                                         int64_t reduction) {
  LTC_FN_COUNTER("mnm::");
...
at::Tensor AtenMNMType::le(const at::Tensor& self, const at::Scalar& other) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::le(bridge::mnm_backend::GetLtcTensor(self), other));
}

at::Tensor AtenMNMType::le(const at::Tensor& self, const at::Tensor& other) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::le(bridge::mnm_backend::GetLtcTensor(self), bridge::mnm_backend::GetLtcTensor(other)));
}
...
at::Tensor AtenMNMType::leaky_relu(const at::Tensor& self,
                                   const at::Scalar& negative_slope) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(LazyTensor::leaky_relu(
      bridge::mnm_backend::GetLtcTensor(self), negative_slope.to<double>()));
}

at::Tensor& AtenMNMType::leaky_relu_(at::Tensor& self,
                                     const at::Scalar& negative_slope) {
  if (InPlaceMustUseNNC(self) == ExecutionKind::NNC) {
    LTC_FN_COUNTER("mnm::");
    LazyTensor self_tensor = bridge::mnm_backend::GetLtcTensor(self);
...
at::Tensor AtenMNMType::leaky_relu_backward(const at::Tensor& grad_output,
                                            const at::Tensor& self,
                                            const at::Scalar& negative_slope,
                                            bool self_is_result) {
  ...
  return AtenMNMTypeDefault::leaky_relu_backward(
...
at::Tensor AtenMNMType::log10(const at::Tensor& self) {
  ...
  return bridge::AtenFromLtcTensor(LazyTensor::log_base(
      bridge::mnm_backend::GetLtcTensor(self), ir::OpKind(at::aten::log10), 10.0));
}
...
at::Tensor AtenMNMType::log1p(const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::log1p(bridge::mnm_backend::GetLtcTensor(self)));
}
...
at::Tensor AtenMNMType::log2(const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(LazyTensor::log_base(
      bridge::mnm_backend::GetLtcTensor(self), ir::OpKind(at::aten::log2), 2.0));
}
...
at::Tensor AtenMNMType::log_sigmoid_backward(const at::Tensor& grad_output,
                                             const at::Tensor& self,
...
std::tuple<at::Tensor, at::Tensor> AtenMNMType::log_sigmoid_forward(
    const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  auto result_tuple =
      LazyTensor::log_sigmoid_forward(bridge::mnm_backend::GetLtcTensor(self));
  return std::make_tuple(bridge::AtenFromLtcTensor(std::get<0>(result_tuple)),
                         bridge::AtenFromLtcTensor(std::get<1>(result_tuple)));
}

at::Tensor AtenMNMType::logsumexp(const at::Tensor& self, at::IntArrayRef dim,
                                  bool keepdim) {
...
at::Tensor AtenMNMType::logdet(const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::logdet(bridge::mnm_backend::GetLtcTensor(self)));
}
...
at::Tensor AtenMNMType::lt(const at::Tensor& self, const at::Scalar& other) {
  if (UseNNC(self)) {
    LTC_FN_COUNTER("mnm::");
    return bridge::AtenFromLtcTensor(
        LazyTensor::lt(bridge::mnm_backend::GetLtcTensor(self), other));
  }
  return AtenMNMTypeDefault::lt(self, other);
}
...
at::Tensor& AtenMNMType::masked_scatter_(at::Tensor& self,
...
at::Tensor AtenMNMType::masked_select(const at::Tensor& self,
                                      const at::Tensor& mask) {
  LTC_FN_COUNTER("mnm::");
  LazyTensor self_tensor = bridge::mnm_backend::GetLtcTensor(self);
...
std::tuple<at::Tensor, at::Tensor> AtenMNMType::max(const at::Tensor& self,
                                                    int64_t dim, bool keepdim) {
  return AtenMNMTypeDefault::max(self, dim, keepdim);
}

at::Tensor AtenMNMType::maximum(const at::Tensor& self,
                                const at::Tensor& other) {
  LTC_FN_COUNTER("mnm::");
  return DoBinaryOp(self, other,
                    [&](const LazyTensor& xself, const LazyTensor& xother,
...
std::tuple<at::Tensor&, at::Tensor&> AtenMNMType::max_out(
  ...
  LazyTensor::max_out(max_tensor, max_values_tensor, bridge::mnm_backend::GetLtcTensor(self),
                      dim, keepdim);
  return std::forward_as_tuple(max, max_values);
}

at::Tensor AtenMNMType::max_pool2d(const at::Tensor& self,
                                   at::IntArrayRef kernel_size,
                                   at::IntArrayRef stride,
...
std::tuple<at::Tensor, at::Tensor> AtenMNMType::max_pool2d_with_indices(
  ...
  if (IsNonTrivialDilation(dilation)) {
    return AtenMNMTypeDefault::max_pool2d_with_indices(
        self, kernel_size, stride, padding, dilation, ceil_mode);
  }
...
at::Tensor AtenMNMType::max_pool3d(const at::Tensor& self,
                                   at::IntArrayRef kernel_size,
                                   at::IntArrayRef stride,
                                   at::IntArrayRef padding,
                                   at::IntArrayRef dilation, bool ceil_mode) {
...
std::tuple<at::Tensor, at::Tensor> AtenMNMType::max_pool3d_with_indices(
  ...
  // Lowering when ceil_mode or dilation is set not supported yet.
  if (IsNonTrivialDilation(dilation)) {
    return AtenMNMTypeDefault::max_pool3d_with_indices(
        self, kernel_size, stride, padding, dilation, ceil_mode);
  }
  auto outputs = LazyTensor::max_pool_nd(
      bridge::mnm_backend::GetLtcTensor(self), /*spatial_dim_count=*/3,
...
at::Tensor AtenMNMType::max_unpool2d(const at::Tensor& self,
                                     const at::Tensor& indices,
                                     at::IntArrayRef output_size) {
  LTC_FN_COUNTER("mnm::");
...
at::Tensor AtenMNMType::max_unpool2d_backward(const at::Tensor& grad_output,
                                              const at::Tensor& self,
                                              const at::Tensor& indices,
                                              at::IntArrayRef output_size) {
  LTC_FN_COUNTER("mnm::");
...
at::Tensor AtenMNMType::max_unpool3d(const at::Tensor& self,
                                     const at::Tensor& indices,
                                     at::IntArrayRef output_size,
                                     at::IntArrayRef stride,
                                     at::IntArrayRef padding) {
...
at::Tensor AtenMNMType::max_unpool3d_backward(const at::Tensor& grad_output,
                                              const at::Tensor& self,
                                              const at::Tensor& indices,
                                              at::IntArrayRef output_size,
                                              at::IntArrayRef stride,
...
at::Tensor AtenMNMType::mean(const at::Tensor& self,
                             c10::optional<at::ScalarType> dtype) {
  LTC_FN_COUNTER("mnm::");
  LazyTensor self_tensor = bridge::mnm_backend::GetLtcTensor(self);
...
at::Tensor AtenMNMType::mean(const at::Tensor& self, at::IntArrayRef dim,
                             bool keepdim,
                             c10::optional<at::ScalarType> dtype) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(LazyTensor::mean(
      bridge::mnm_backend::GetLtcTensor(self), lazy_tensors::util::ToVector<lazy_tensors::int64>(dim),
...
std::tuple<at::Tensor, at::Tensor> AtenMNMType::min(const at::Tensor& self,
                                                    int64_t dim, bool keepdim) {
  return AtenMNMTypeDefault::min(self, dim, keepdim);
}

at::Tensor AtenMNMType::minimum(const at::Tensor& self,
                                const at::Tensor& other) {
  LTC_FN_COUNTER("mnm::");
  return DoBinaryOp(self, other,
                    [&](const LazyTensor& xself, const LazyTensor& xother,
...
std::tuple<at::Tensor&, at::Tensor&> AtenMNMType::min_out(
...
at::Tensor AtenMNMType::mse_loss(const at::Tensor& self,
                                 const at::Tensor& target, int64_t reduction) {
  LTC_FN_COUNTER("mnm::");
...
at::Tensor AtenMNMType::mse_loss_backward(const at::Tensor& grad_output,
                                          const at::Tensor& self,
                                          const at::Tensor& target,
                                          int64_t reduction) {
  LTC_FN_COUNTER("mnm::");
...
at::Tensor AtenMNMType::mul(const at::Tensor& self, const at::Tensor& other) {
  ...
  return AtenMNMTypeDefault::mul(self, other);
}
...
at::Tensor AtenMNMType::mv(const at::Tensor& self, const at::Tensor& vec) {
  ...
  return bridge::AtenFromLtcTensor(
      LazyTensor::mv(bridge::mnm_backend::GetLtcTensor(self), bridge::mnm_backend::GetLtcTensor(vec)));
}

at::Tensor& AtenMNMType::mv_out(const at::Tensor& self, const at::Tensor& vec,
                                at::Tensor& out) {
  LTC_FN_COUNTER("mnm::");
  // xla::dot doesn't support integer types.
  if (!at::native::is_floating_point(self) ||
...
std::tuple<at::Tensor, at::Tensor, at::Tensor>
AtenMNMType::native_batch_norm_backward(
...
at::Tensor AtenMNMType::ne(const at::Tensor& self, const at::Scalar& other) {
  if (UseNNC(self)) {
    LTC_FN_COUNTER("mnm::");
    return bridge::AtenFromLtcTensor(
        LazyTensor::ne(bridge::mnm_backend::GetLtcTensor(self), other));
  }
  return AtenMNMTypeDefault::ne(self, other);
}

at::Tensor AtenMNMType::ne(const at::Tensor& self, const at::Tensor& other) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::ne(bridge::mnm_backend::GetLtcTensor(self), bridge::mnm_backend::GetLtcTensor(other)));
}
  ...
  if (UseNNC(self)) {
    ...
    LTC_CHECK(self.scalar_type() != at::kBool)
        << "Negation, the `-` operator, on a bool tensor is not supported. If "
           ...
           "operator instead.";
    return bridge::AtenFromLtcTensor(
        LazyTensor::neg(bridge::mnm_backend::GetLtcTensor(self)));
  }
  return AtenMNMTypeDefault::neg(self);
}
...
at::Tensor AtenMNMType::nll_loss2d_backward(
    const at::Tensor& grad_output, const at::Tensor& self,
    const at::Tensor& target, const c10::optional<at::Tensor>& weight,
  ...
  return bridge::AtenFromLtcTensor(LazyTensor::nll_loss2d_backward(
      bridge::mnm_backend::GetLtcTensor(grad_output), self_tensor,
      bridge::mnm_backend::GetLtcTensor(target), weight_tensor, reduction, ignore_index,
      total_weight_tensor));
}
...
at::Tensor AtenMNMType::nll_loss_backward(
    const at::Tensor& grad_output, const at::Tensor& self,
    const at::Tensor& target, const c10::optional<at::Tensor>& weight,
    int64_t reduction, int64_t ignore_index, const at::Tensor& total_weight) {
  LTC_FN_COUNTER("mnm::");
...
at::Tensor AtenMNMType::norm(const at::Tensor& self,
...
at::Tensor AtenMNMType::normal(const at::Tensor& mean, const at::Tensor& std,
  ...
  return bridge::AtenFromLtcTensor(LazyTensor::normal(
      bridge::mnm_backend::GetLtcTensor(mean), bridge::mnm_backend::GetLtcTensor(std)));
}
...
at::Tensor AtenMNMType::permute(const at::Tensor& self, at::IntArrayRef dims) {
  ...
  auto result = AtenMNMTypeDefault::permute(self, dims);
  MarkAsInteropView(result);
  return result;
}

at::Tensor AtenMNMType::pow(const at::Tensor& self,
...
at::Tensor AtenMNMType::pow(const at::Tensor& self,
  ...
  return bridge::AtenFromLtcTensor(LazyTensor::pow(
      bridge::mnm_backend::GetLtcTensor(self), bridge::mnm_backend::GetLtcTensor(exponent)));
}

at::Tensor AtenMNMType::pow(const at::Scalar& self,
                            const at::Tensor& exponent) {
  LTC_FN_COUNTER("mnm::");
  // xla::Pow() doesn't support integer types.
...
at::Tensor AtenMNMType::prod(const at::Tensor& self,
                             c10::optional<at::ScalarType> dtype) {
  LTC_FN_COUNTER("mnm::");
  LazyTensor self_tensor = bridge::mnm_backend::GetLtcTensor(self);
...
at::Tensor& AtenMNMType::put_(at::Tensor& self, const at::Tensor& index,
...
std::tuple<at::Tensor, at::Tensor> AtenMNMType::qr(const at::Tensor& self,
                                                   bool some) {
  LTC_FN_COUNTER("mnm::");
...
at::Tensor& AtenMNMType::random_(at::Tensor& self, int64_t from,
...
at::Tensor& AtenMNMType::random_(at::Tensor& self,
                                 c10::optional<at::Generator> generator) {
  LTC_FN_COUNTER("mnm::");
  if (generator.has_value() && generator->defined()) {
...
at::Tensor AtenMNMType::reciprocal(const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::reciprocal(bridge::mnm_backend::GetLtcTensor(self)));
}
...
at::Tensor AtenMNMType::reflection_pad2d(const at::Tensor& self,
                                         at::IntArrayRef padding) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(LazyTensor::reflection_pad2d(
      bridge::mnm_backend::GetLtcTensor(self), lazy_tensors::util::ToVector<lazy_tensors::int64>(padding)));
}
...
at::Tensor AtenMNMType::relu(const at::Tensor& self) {
  if (UseNNC(self)) {
    LTC_FN_COUNTER("mnm::");
    return bridge::AtenFromLtcTensor(
        LazyTensor::relu(bridge::mnm_backend::GetLtcTensor(self)));
  }
  return AtenMNMTypeDefault::relu(self);
}
...
at::Tensor AtenMNMType::remainder(const at::Tensor& self,
                                  const at::Tensor& other) {
  LTC_FN_COUNTER("mnm::");
...
at::Tensor AtenMNMType::repeat(const at::Tensor& self,
                               at::IntArrayRef repeats) {
  return AtenMNMTypeDefault::repeat(self, repeats);
}

at::Tensor AtenMNMType::replication_pad1d(const at::Tensor& self,
                                          at::IntArrayRef padding) {
  LTC_FN_COUNTER("mnm::");
...
at::Tensor AtenMNMType::replication_pad1d_backward(
    const at::Tensor& grad_output, const at::Tensor& self,
    at::IntArrayRef padding) {
  LTC_FN_COUNTER("mnm::");
...
at::Tensor AtenMNMType::replication_pad2d(const at::Tensor& self,
                                          at::IntArrayRef padding) {
  LTC_FN_COUNTER("mnm::");
...
at::Tensor AtenMNMType::replication_pad2d_backward(
    const at::Tensor& grad_output, const at::Tensor& self,
    at::IntArrayRef padding) {
  LTC_FN_COUNTER("mnm::");
...
const at::Tensor& AtenMNMType::resize_(
...
at::Tensor AtenMNMType::round(const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::round(bridge::mnm_backend::GetLtcTensor(self)));
}
...
at::Tensor AtenMNMType::rrelu_with_noise(
  ...
  if (generator.has_value() && generator->defined()) {
    ...
    return AtenMNMTypeDefault::rrelu_with_noise(self, noise, lower, upper,
                                                training, generator);
  }
...
at::Tensor AtenMNMType::rrelu_with_noise_backward(
    const at::Tensor& grad_output, const at::Tensor& self,
...
at::Tensor AtenMNMType::rsqrt(const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::rsqrt(bridge::mnm_backend::GetLtcTensor(self)));
}
...
at::Tensor AtenMNMType::rsub(const at::Tensor& self, const at::Tensor& other,
  ...
  return AtenMNMTypeDefault::rsub(self, other, alpha);
}
...
at::Tensor& AtenMNMType::scatter_(at::Tensor& self, int64_t dim,
                                  const at::Tensor& index,
                                  const at::Tensor& src) {
  LTC_FN_COUNTER("mnm::");
  LazyTensor self_tensor = bridge::mnm_backend::GetLtcTensor(self);
...
at::Tensor& AtenMNMType::scatter_add_(at::Tensor& self, int64_t dim,
                                      const at::Tensor& index,
                                      const at::Tensor& src) {
  LTC_FN_COUNTER("mnm::");
  LazyTensor self_tensor = bridge::mnm_backend::GetLtcTensor(self);
...
at::Tensor AtenMNMType::select(const at::Tensor& self, int64_t dim,
                               int64_t index) {
  if (ForceNNC()) {
    LTC_FN_COUNTER("mnm::");
    return bridge::AtenFromLtcTensor(
  ...
  return AtenMNMTypeDefault::select(self, dim, index);
}
...
at::Tensor AtenMNMType::sigmoid(const at::Tensor& self) {
  if (UseNNC(self)) {
    LTC_FN_COUNTER("mnm::");
    return bridge::AtenFromLtcTensor(
        LazyTensor::sigmoid(bridge::mnm_backend::GetLtcTensor(self)));
  }
  return AtenMNMTypeDefault::sigmoid(self);
}
...
at::Tensor AtenMNMType::sigmoid_backward(const at::Tensor& grad_output,
                                         const at::Tensor& output) {
  if (UseNNC(grad_output)) {
    LTC_FN_COUNTER("mnm::");
  ...
  return AtenMNMTypeDefault::sigmoid_backward(grad_output, output);
}

at::Tensor AtenMNMType::sign(const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::sign(bridge::mnm_backend::GetLtcTensor(self)));
}
...
at::Tensor AtenMNMType::sinh(const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::sinh(bridge::mnm_backend::GetLtcTensor(self)));
}
...
at::Tensor AtenMNMType::slice(const at::Tensor& self, int64_t dim,
  ...
  if (UseNNCViews(self_tensor)) {
    ...
    return bridge::AtenFromLtcTensor(LazyTensor::slice(
        bridge::mnm_backend::GetLtcTensor(self), dim, start_val, end_val, step));
  }
  LTC_FN_TRACK(3);
...
at::Tensor AtenMNMType::smooth_l1_loss(const at::Tensor& self,
                                       const at::Tensor& target,
...
at::Tensor AtenMNMType::softplus_backward(const at::Tensor& grad_output,
                                          const at::Tensor& self,
                                          const at::Scalar& beta,
                                          const at::Scalar& threshold,
                                          const at::Tensor& output) {
...
at::Tensor AtenMNMType::softshrink(const at::Tensor& self,
                                   const at::Scalar& lambda) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
...
at::Tensor AtenMNMType::softshrink_backward(const at::Tensor& grad_out,
                                            const at::Tensor& self,
                                            const at::Scalar& lambda) {
  LTC_FN_COUNTER("mnm::");
...
std::tuple<at::Tensor, at::Tensor> AtenMNMType::sort(const at::Tensor& self,
                                                     int64_t dim,
                                                     bool descending) {
  LTC_FN_COUNTER("mnm::");
  auto results = LazyTensor::topk(bridge::mnm_backend::GetLtcTensor(self), self.size(dim),
                                  dim, descending, true);
  return std::make_tuple(bridge::AtenFromLtcTensor(std::get<0>(results)),
                         bridge::AtenFromLtcTensor(std::get<1>(results)));
}

std::vector<at::Tensor> AtenMNMType::split(const at::Tensor& self,
                                           int64_t split_size, int64_t dim) {
  LTC_FN_COUNTER("mnm::");
  auto xla_tensors =
      LazyTensor::split(bridge::mnm_backend::GetLtcTensor(self), split_size, dim);
  return bridge::AtenFromLtcTensors(xla_tensors);
}

std::vector<at::Tensor> AtenMNMType::split_with_sizes(
    const at::Tensor& self, at::IntArrayRef split_sizes, int64_t dim) {
  LTC_FN_COUNTER("mnm::");
  auto xla_tensors = LazyTensor::split_with_sizes(
      bridge::mnm_backend::GetLtcTensor(self), Helpers::I64List(split_sizes), dim);
  return bridge::AtenFromLtcTensors(xla_tensors);
}
...
at::Tensor AtenMNMType::sqrt(const at::Tensor& self) {
  if (UseNNC(self)) {
    LTC_FN_COUNTER("mnm::");
    return bridge::AtenFromLtcTensor(
        LazyTensor::sqrt(bridge::mnm_backend::GetLtcTensor(self)));
  }
  return AtenMNMTypeDefault::sqrt(self);
}
...
at::Tensor AtenMNMType::squeeze(const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::squeeze(bridge::mnm_backend::GetLtcTensor(self)));
}
...
at::Tensor AtenMNMType::std(const at::Tensor& self, at::IntArrayRef dim,
                            bool unbiased, bool keepdim) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(LazyTensor::std(
      bridge::mnm_backend::GetLtcTensor(self), lazy_tensors::util::ToVector<lazy_tensors::int64>(dim), keepdim,
      /*correction=*/unbiased ? 1 : 0));
}

at::Tensor AtenMNMType::std(const at::Tensor& self,
...
at::Tensor AtenMNMType::sub(const at::Tensor& self, const at::Tensor& other,
  ...
  return AtenMNMTypeDefault::sub(self, other, alpha);
}
...
at::Tensor& AtenMNMType::sub_(at::Tensor& self, const at::Tensor& other,
                              const at::Scalar& alpha) {
  if (InPlaceUseNNC(self) == ExecutionKind::NNC) {
    LTC_FN_COUNTER("mnm::");
    CheckBinaryOpTypePromotion(self, self, other);
...
at::Tensor& AtenMNMType::sub_(at::Tensor& self, const at::Scalar& other,
                              const at::Scalar& alpha) {
  if (InPlaceMustUseNNC(self) == ExecutionKind::NNC) {
    LTC_FN_COUNTER("mnm::");
    CheckBinaryOpTypePromotion(self, self, other);
...
at::Tensor AtenMNMType::sum(const at::Tensor& self,
                            c10::optional<at::ScalarType> dtype) {
  LTC_FN_COUNTER("mnm::");
  LazyTensor self_tensor = bridge::mnm_backend::GetLtcTensor(self);
...
at::Tensor AtenMNMType::sum(const at::Tensor& self, at::IntArrayRef dim,
...
std::tuple<at::Tensor, at::Tensor, at::Tensor> AtenMNMType::svd(
...
std::tuple<at::Tensor, at::Tensor> AtenMNMType::symeig(const at::Tensor& self,
                                                       bool eigenvectors,
                                                       bool upper) {
  LTC_FN_COUNTER("mnm::");
  auto results =
      LazyTensor::symeig(bridge::mnm_backend::GetLtcTensor(self), eigenvectors, upper);
  return std::make_tuple(bridge::AtenFromLtcTensor(std::get<0>(results)),
                         bridge::AtenFromLtcTensor(std::get<1>(results)));
}
...
at::Tensor AtenMNMType::t(const at::Tensor& self) {
  ...
  auto result = AtenMNMTypeDefault::t(self);
  MarkAsInteropView(result);
  return result;
}
...
at::Tensor AtenMNMType::take(const at::Tensor& self, const at::Tensor& index) {
  ...
  return bridge::AtenFromLtcTensor(LazyTensor::take(
      bridge::mnm_backend::GetLtcTensor(self), bridge::mnm_backend::GetLtcTensor(index)));
}
...
at::Tensor AtenMNMType::tanh(const at::Tensor& self) {
  if (UseNNC(self)) {
    LTC_FN_COUNTER("mnm::");
    return bridge::AtenFromLtcTensor(
        LazyTensor::tanh(bridge::mnm_backend::GetLtcTensor(self)));
  }
  return AtenMNMTypeDefault::tanh(self);
}
...
at::Tensor AtenMNMType::tanh_backward(const at::Tensor& grad_output,
                                      const at::Tensor& output) {
  if (UseNNC(grad_output)) {
    LTC_FN_COUNTER("mnm::");
  ...
  return AtenMNMTypeDefault::tanh_backward(grad_output, output);
}

at::Tensor AtenMNMType::threshold(const at::Tensor& self,
                                  const at::Scalar& threshold,
                                  const at::Scalar& value) {
  LTC_FN_COUNTER("mnm::");
...
at::Tensor& AtenMNMType::threshold_(at::Tensor& self,
                                    const at::Scalar& threshold,
                                    const at::Scalar& value) {
  if (InPlaceMustUseNNC(self) == ExecutionKind::NNC) {
    LTC_FN_COUNTER("mnm::");
...
at::Tensor AtenMNMType::threshold_backward(const at::Tensor& grad_output,
                                           const at::Tensor& self,
                                           const at::Scalar& threshold) {
  if (UseNNC(grad_output)) {
    LTC_FN_COUNTER("mnm::");
  ...
  return AtenMNMTypeDefault::threshold_backward(grad_output, self, threshold);
}

std::tuple<at::Tensor, at::Tensor> AtenMNMType::topk(const at::Tensor& self,
                                                     int64_t k, int64_t dim,
                                                     bool largest,
                                                     bool sorted) {
  LTC_FN_COUNTER("mnm::");
  auto results =
      LazyTensor::topk(bridge::mnm_backend::GetLtcTensor(self), k, dim, largest, sorted);
  return std::make_tuple(bridge::AtenFromLtcTensor(std::get<0>(results)),
                         bridge::AtenFromLtcTensor(std::get<1>(results)));
}
...
at::Tensor AtenMNMType::trace(const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::trace(bridge::mnm_backend::GetLtcTensor(self)));
}

at::Tensor AtenMNMType::transpose(const at::Tensor& self, int64_t dim0,
                                  int64_t dim1) {
  LazyTensor self_tensor = bridge::mnm_backend::GetLtcTensor(self);
  if (UseNNCViews(self_tensor)) {
    LTC_FN_COUNTER("mnm::");
  ...
  auto result = AtenMNMTypeDefault::transpose(self, dim0, dim1);
  MarkAsInteropView(result);
  return result;
}

at::Tensor& AtenMNMType::transpose_(at::Tensor& self, int64_t dim0,
                                    int64_t dim1) {
  LTC_FN_COUNTER("mnm::");
  LazyTensor self_tensor = bridge::mnm_backend::GetLtcTensor(self);
...
std::tuple<at::Tensor, at::Tensor> AtenMNMType::triangular_solve(
  ...
  auto results = LazyTensor::triangular_solve(
      bridge::mnm_backend::GetLtcTensor(b), bridge::mnm_backend::GetLtcTensor(A), /*left_side=*/true,
...
at::Tensor AtenMNMType::trunc(const at::Tensor& self) {
  LTC_FN_COUNTER("mnm::");
  return bridge::AtenFromLtcTensor(
      LazyTensor::trunc(bridge::mnm_backend::GetLtcTensor(self)));
}
...
std::vector<at::Tensor> AtenMNMType::unbind(const at::Tensor& self,
                                            int64_t dim) {
  LTC_FN_COUNTER("mnm::");
...
at::Tensor AtenMNMType::upsample_bilinear2d(const at::Tensor& self,
                                            at::IntArrayRef output_size,
                                            bool align_corners,
  ...
  if (self_tensor.GetDevice().hw_type != DeviceType::TPU ||
    ...
    return AtenMNMTypeDefault::upsample_bilinear2d(
...
at::Tensor AtenMNMType::upsample_bilinear2d_backward(
  ...
  if (grad_output_tensor.GetDevice().hw_type != DeviceType::TPU ||
      (scales_h && *scales_h != 1.0) || (scales_w && *scales_w != 1.0)) {
    return AtenMNMTypeDefault::upsample_bilinear2d_backward(
...
at::Tensor AtenMNMType::upsample_nearest2d(
  ...
  if (input_tensor.GetDevice().hw_type != DeviceType::TPU) {
    return AtenMNMTypeDefault::upsample_nearest2d(input, output_size,
                                                  scale_factors);
  }
  absl::Span<const lazy_tensors::int64> input_dims =
...
at::Tensor AtenMNMType::upsample_nearest2d_backward(
  ...
  // XLA lowering.
  if (grad_output_tensor.GetDevice().hw_type != DeviceType::TPU) {
    return AtenMNMTypeDefault::upsample_nearest2d_backward(
...
at::Tensor AtenMNMType::upsample_nearest2d(const at::Tensor& self,
                                           at::IntArrayRef output_size,
                                           c10::optional<double> scales_h,
                                           c10::optional<double> scales_w) {
  LTC_FN_COUNTER("mnm::");
  ...
  if (self_tensor.GetDevice().hw_type != DeviceType::TPU ||
      (scales_h && *scales_h != 1.0) || (scales_w && *scales_w != 1.0)) {
    return AtenMNMTypeDefault::upsample_nearest2d(self, output_size, scales_h,
                                                  scales_w);
  }
  return bridge::AtenFromLtcTensor(LazyTensor::upsample_nearest2d(
      self_tensor, lazy_tensors::util::ToVector<lazy_tensors::int64>(output_size)));
...
at::Tensor AtenMNMType::var(const at::Tensor& self, at::IntArrayRef dim,
                            bool unbiased, bool keepdim) {
  LTC_FN_COUNTER("mnm::");
  LazyTensor self_tensor = bridge::mnm_backend::GetLtcTensor(self);
  return bridge::AtenFromLtcTensor(
...
at::Tensor AtenMNMType::var(const at::Tensor& self,
                            c10::optional<at::IntArrayRef> dim,
                            c10::optional<int64_t> correction, bool keepdim) {
  LTC_FN_COUNTER("mnm::");
  LazyTensor self_tensor = bridge::mnm_backend::GetLtcTensor(self);
...
at::Tensor AtenMNMType::view(const at::Tensor& self, at::IntArrayRef size) {
  ...
  auto result = AtenMNMTypeDefault::view(self, size);
  MarkAsInteropView(result);
  return result;
}
