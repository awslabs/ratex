...
class GenericComputationMNMNode : public Object {
 public:
  ...
  static constexpr const char* _type_key = "torch_mnm.GenericComputationMNM";
...
class ShapeNode : public Object {
 public:
  ...
  static constexpr const char* _type_key = "torch_mnm.Shape";
  static constexpr const bool _type_has_method_sequal_reduce = true;
  static constexpr const bool _type_has_method_shash_reduce = true;
...
class ProgramShapeNode : public Object {
 public:
  ...
  static constexpr const char* _type_key = "torch_mnm.ProgramShape";
  static constexpr const bool _type_has_method_sequal_reduce = true;
  static constexpr const bool _type_has_method_shash_reduce = true;
...
class ComputationNode : public Object {
 public:
  ...
  static constexpr const char* _type_key = "torch_mnm.Computation";
  static constexpr const bool _type_has_method_sequal_reduce = true;
  static constexpr const bool _type_has_method_shash_reduce = true;
...
class BaseComputationNode : public ComputationNode {
 public:
  ...
  static constexpr const char* _type_key = "torch_mnm.BaseComputation";
  static constexpr const bool _type_has_method_sequal_reduce = true;
  static constexpr const bool _type_has_method_shash_reduce = true;
